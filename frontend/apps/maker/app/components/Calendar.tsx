...
import {
  calendar,
  type CalendarProps as CalendarVariants,
} from "@tailus/themer";
    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button_previous: nav_button_previous({
          class: classNames?.nav_button_previous,
        }),
        nav_button_next: nav_button_next({
          class: classNames?.nav_button_next,
        }),
        ...
        day_range_middle: day_range_middle({
          intent,
          class: classNames?.day_range_middle,
        }),
