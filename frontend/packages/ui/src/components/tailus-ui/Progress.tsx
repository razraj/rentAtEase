...
import {
  progress,
  type RootProps,
  type IndicatorProps as IndicatorVariants,
} from "@tailus/themer";
...
>(
  (
    ...
    if (withHighlight && withStripes) {
      throw new Error(
        "The highlight and stripes styles cannot be applied together!"
      );
    }
...
export { ProgressRoot as Root, ProgressIndicator as Indicator };
