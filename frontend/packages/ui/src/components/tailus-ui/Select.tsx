...
const SelectPrimitivePortal = SelectPrimitive.Portal;
const SelectPrimitiveValue = SelectPrimitive.Value;
const SelectPrimitiveIcon = SelectPrimitive.Icon;
const SelectPrimitiveViewport = SelectPrimitive.Viewport;
const SelectPrimitiveItemText = SelectPrimitive.ItemText;

export {
  SelectContent as Content,
  SelectGroup as Group,
  SelectPrimitiveIcon as Icon,
  SelectItem as Item,
  SelectItemIndicator as ItemIndicator,
  SelectPrimitiveItemText as ItemText,
  SelectLabel as Label,
  SelectPrimitivePortal as Portal,
  SelectPrimitiveRoot as Root,
  ...
  SelectPrimitiveValue as Value,
  SelectPrimitiveViewport as Viewport,
};
